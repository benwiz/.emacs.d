...
* Notes
C-x v ~     change version of file
magit-log-buffer-file      history of file, this is amazing
* To Do
** Organize this file
** make the colors of scroll margin dimmer to signal it's out of the main scroll area. Super cool!
...
#+BEGIN_SRC emacs-lisp
  (if *is-a-mac*
      (progn
        ...
        (add-to-list 'custom-theme-load-path "/Users/j/.emacs.d/themes"))
